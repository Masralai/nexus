  ...
  return (
    <main className="bg-[#09090b] min-h-screen py-10">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <p className="font-mono text-[11px] leading-relaxed text-zinc-600 border-t border-zinc-800 pt-6">
          Lab note: Getting Started above is the refactor of InstallSection{" "}
          <span className="text-zinc-500">web/app/page.tsx:382</span> into four steps. Production / keeps
          #install unchanged. Promote by importing GettingStartedSection into page.tsx when approved.
        </p>
      </div>
    </main>
  );
